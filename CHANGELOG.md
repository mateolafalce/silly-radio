...
- A random SFW or Sketchy image from every Wallhaven category (`categories=111`, `purity=110`) is published as temporary MPRIS cover art and rotated every minute, retaining the last valid image when a refresh fails.
